...
export default function Programmers() {
  ...
  const[progers, setProgers] = useState(listOfAwesome)
  ...
  const getNameOfFeatured = () => {
    ...
    if(progId == null) {
      ...
      const featuredProg = progers.find(programmer => {
        return progID == programmer.id;
      })
      return featuredProg.name
    }
  };
    ...
    <div className='widget-programmers container'>
      ...
      <div className='programmers'>
      ...
      </div>
        {
          ...
          progID != null
            ? <div style={style}>🎉 Let&apos;s clebrate {getNameOfFeatured()}! 🥳</div>
